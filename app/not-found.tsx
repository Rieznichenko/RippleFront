...
export default function NotFound() {
  return (
    <div
      className="relative h-[100%] bg-[#1B1B1B]"
      style={{
    ...
    >
      <img
        src={camelBg.src}
        className="relative h-screen transform scale-x-[-1] right-auto mx-auto left-auto p-10 -z-0"
      />
      ...
      <div className="absolute top-0 left-0 right-0 z-10 w-[80%] mx-auto ">
        ...
        <div className="rounded-2xl bg-opacity-60 my-10 p-12 font-lato text-2xl text-white text-center bg-gradient-to-r from-opacity-30 to-opacity-5 bg-[#45484E] backdrop-blur-40">
